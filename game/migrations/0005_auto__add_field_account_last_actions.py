...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.last_actions'
        db.add_column(u'game_account', 'last_actions',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.last_actions'
        db.delete_column(u'game_account', 'last_actions')
