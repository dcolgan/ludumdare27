...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.last_col'
        db.add_column(u'game_account', 'last_col',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.last_row'
        db.add_column(u'game_account', 'last_row',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.last_col'
        db.delete_column(u'game_account', 'last_col')

        # Deleting field 'Account.last_row'
        db.delete_column(u'game_account', 'last_row')
