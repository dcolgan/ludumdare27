...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.flags_gotten'
        db.add_column(u'game_account', 'flags_gotten',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Account.enemies_tagged'
        db.add_column(u'game_account', 'enemies_tagged',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.flags_gotten'
        db.delete_column(u'game_account', 'flags_gotten')

        # Deleting field 'Account.enemies_tagged'
        db.delete_column(u'game_account', 'enemies_tagged')
