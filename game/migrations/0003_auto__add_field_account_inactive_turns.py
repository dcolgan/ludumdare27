...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.inactive_turns'
        db.add_column(u'game_account', 'inactive_turns',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.inactive_turns'
        db.delete_column(u'game_account', 'inactive_turns')
    ...
    models = {
        ...
        u'game.account': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inactive_turns': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
